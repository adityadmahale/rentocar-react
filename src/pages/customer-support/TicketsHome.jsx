...
function TicketsHome() {
  ...
  return (
    ...
    <div>
    <div className="first">
      <TextField id="ticket-id" label="Ticket ID" variant="filled"></TextField>
    </div>
    <div className="second">
    <TextField id="assigned-to" label="Assigned To" variant="filled"></TextField>
    </div>
    <div className="second">
    <FormControl variant="filled" sx={{ m: 0, minWidth: 220 }}>
    <InputLabel id="status-label">Status</InputLabel>
    <Select labelId="status-label"  id="demo-simple-select"  value={state.status}  onChange={handleChangeStatus}>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell >
                <button type="submit" className="btn btn-info"  onClick={console.log("Click")}>
                    Edit
                </button>
                </TableCell>
            </TableRow>
